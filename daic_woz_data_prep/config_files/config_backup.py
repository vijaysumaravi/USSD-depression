...
DATASET = '/data/vijay/dataset/daic_woz_old/data'
WORKSPACE_MAIN_DIR = '/data/vijay/dataset/daic_woz_old/audio_data/feats_DepAudioNet'
WORKSPACE_FILES_DIR = '/data/vijay/workdir/model_arch/data_processing_depaudionet/'
LABELS_FOLDER='/data/vijay/dataset/daic_woz_old/labels/'
