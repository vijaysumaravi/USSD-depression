...
class GenerateData:
    ...
    def generate_development_data(self, epoch):
        ...
        if self.checkpoint:
            ...
            random.shuffle(indices)
            #comment to prevent shuffling to get same order of segment target
            pass
        while pointer < len(indices):
            ...
            yield batch_data, batch_labels, batch_folders, locs_array, batch_indices
