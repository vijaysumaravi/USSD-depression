...
def get_lengths(data, labels, config):
    ...
    for p in range(len(labels[0])):
        d = data[p][0]
        if exp_type == 'mel' or exp_type == 'logmel' or exp_type=='wav2vec2' or exp_type == 'compare16' or exp_type == 'compare16_delta':
            d = d.reshape(freq_bins, -1) # inshape (freq_dim, num_segment)
