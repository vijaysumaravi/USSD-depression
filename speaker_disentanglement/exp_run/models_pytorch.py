...
class CustomComparE16(nn.Module):
    def __init__(self):
        super(CustomComparE16, self).__init__()
        self.conv = ConvBlock1d(in_channels=130,
                                out_channels=256,
                                kernel=3,
                                stride=1,
                                pad=1,
    ...
    def forward(self, net_input):
        ...
        return mdd, hidden_state[0][-1]


class CustomComparE16_adv(nn.Module):
    def __init__(self):
        super(CustomComparE16_adv, self).__init__()
        self.conv = ConvBlock1d(in_channels=130,
                                out_channels=256,
                                kernel=3,
                                stride=1,
